  ...
  return (
   <form className="mt-2">   
    ...
    <div className="relative flex justify-center">
        ...
        <input type="search" value={searchTerm} id="default-search" onChange={(e) => handleChange(e)} className="block w-4/5 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items..." required />
